...
IOException
	...
	if(p.getProperty( "execution_env").equalsIgnoreCase("local"))         // oka vela remote environment aiythe then execute below code
	{
...
else if(p.getProperty("exceution_env").equalsIgnoreCase("local"))
{
